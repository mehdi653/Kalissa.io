  ...
  return (
    ...
    >
      ...
      <div className="waiting-title">
        Your creation is being listed with KALISSA...
      </div>
...
const Congrats = (props: {
  ...
  const newTweetURL = () => {
    const params = {
      text: "I've created a new NFT auction on Kalissa.io , check it out!",
      url: `${
        window.location.origin
      }/#/auction/${props.auction?.auction.toString()}`,
      hashtags: 'NFT,Crypto,Kalissa',
      // via: "Metaplex",
      related: 'Kalissa,Solana',
    };
